...
public function previous_transfor(){
 ...
 public function filter_siku_report()
 
 {
  ...
  $to = $this->input->post('to');
   ...
   $this->load->model('queries');
    ...
    $data['transactions'] = $this->queries->get_employee_transaction_filter($from, $to, $comp_id);
    $data['from'] = $from;
    $data['to'] = $to;

    $this->load->view('admin/teller_filter', $data);
